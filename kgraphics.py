...
NOTE: this is a slightly modified version from the original graphics.py
...
class GraphWin(tk.Canvas):
    ...
    def __init__(self, title="Graphics Window",
        ...
        self.bind("<Button-1>", self._onClickLeft)
    ...
    def _onClickLeft(self, e):
        self.mouseX = e.x
        self.mouseY = e.y
        self.mouseButton = 'Left'
        if self._mouseCallback:
            self._mouseCallback(Point(e.x, e.y), 'Left')
    ...
    def _onClickRight(self, e):
        ...
        if self._mouseCallback:
            self._mouseCallback(Point(e.x, e.y), 'Right')
